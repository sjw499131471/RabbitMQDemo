...
@Component
public class FanoutExchangeConfig implements BeanPostProcessor {
    @Resource
    ...
    public Queue fanoutExchangeQueueA() {
        //队列A
        return new Queue(RabbitMQConst.FANOUT_EXCHANGE_QUEUE_A, true, false, false);
    }

    @Bean
    public Queue fanoutExchangeQueueB() {
        //队列B
        return new Queue(RabbitMQConst.FANOUT_EXCHANGE_QUEUE_B, true, false, false);
    }

    @Bean
    public FanoutExchange rabbitmqDemoFanoutExchange() {
        //创建FanoutExchange类型交换机
        return new FanoutExchange(RabbitMQConst.FANOUT_EXCHANGE_DEMO_NAME, true, false);
    }
